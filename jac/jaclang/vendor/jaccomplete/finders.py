...
class CompletionFinder(object):
    ...
    ``jaccomplete.autocomplete()`` directly (it's a convenience instance of this class). It has the same signature as
    ...
    def __call__(
        ...
        .. note::
            ...
            use :meth:`jaccomplete.autocomplete()` directly. It has the same signature as this method.

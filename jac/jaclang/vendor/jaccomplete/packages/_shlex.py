# This copy of shlex.py from Python 3.6 is distributed with jaccomplete.
...
class shlex:
    ...
    def __init__(self, instream=None, infile=None, posix=False, punctuation_chars=False):
        # Modified by jaccomplete: 2/3 compatibility
        ...
        # Modified by jaccomplete: Record last wordbreak position
